<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="LinkWeb.aspx.cs" Inherits="MyWeb.Admins.LinkWeb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<asp:Panel ID="pnView" runat="server">
		...
		<asp:DataGrid ID="grdLinkWeb" runat="server" Width="100%" CssClass="TableView"
			AutoGenerateColumns="False" AllowPaging="True" PageSize="30" PagerStyle-Mode="NumericPages"
			PagerStyle-HorizontalAlign="Center" OnItemDataBound="grdLinkWeb_ItemDataBound"
			OnItemCommand="grdLinkWeb_ItemCommand" OnPageIndexChanged="grdLinkWeb_PageIndexChanged">
			...
			<Columns>
				...
				<asp:BoundColumn DataField="Name" HeaderText="Tên liên kết" ItemStyle-CssClass="Text" Visible="true" />
	...
	<asp:Panel ID="pnUpdate" runat="server" Visible="False">
		<table class="TableUpdate" border="1">
			...
			<tr>
				<th>
					<asp:Label ID="lblName" runat="server" Text="Tên liên kết:"></asp:Label>
				</th>
				<td>
